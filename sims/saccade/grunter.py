...
mem = "2G" # 3G @ 2 thr is minimum, 5G reserves a node and is sig faster
#mem = "3G" # 3G @ 2 thr is minimum, 5G reserves a node and is sig faster
...
def write_sbatch():
    ...
    f.write("export AR=ar\n")
    f.write("export CC=gcc\n")
    f.write("export GXX=g++\n")
    f.write("\n\n")
    f.write("pwd")
    f.write("\n\n")
    f.write("go env")
    ...
    # f.write("ln -s $HOME/ccn_images/CU3D100_20obj_8tick4sac images\n")
