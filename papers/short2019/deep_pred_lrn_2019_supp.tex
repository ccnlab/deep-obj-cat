\documentclass[12pt,twoside]{naturefigs}
...
\def\myheading{ Deep Predictive Learning Supplemental Information}
...
% (JLR) I assume that 0.0160 number should be changed - I changed the layer names to "6" (rather than "3" because there are more layers now) and "1" (rather than 0 - I decided to start counting from 1.)
...
\begin{figure}
  \centering\includegraphics[width=2.5in]{figs/prednet_dropout_meta_within_between}
