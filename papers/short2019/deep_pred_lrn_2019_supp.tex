...
% should this be inter-cluster or intra-cluster?
...
% Simplest is perhaps not a good adjective here. How about the most consistent results or perhaps just say, "The Bp model converged on the same cluster state regardless of starting configuration."
% Having missed a bunch of meetings this summer I'm not fully familiar with how you did the RSA analysis and I'm not following it here. I'm confused re: "initial categories" 
...
% previous sentence awkward - how about "of the LIP layer {\em Where} when pre-training..."
