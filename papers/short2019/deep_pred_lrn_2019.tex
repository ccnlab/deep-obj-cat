...
% (minor - obvious - figure should have a, b, c to follow caption
% caption should be specific about Y-axis which just says correlation without specifying what is correlated
\begin{figure}
