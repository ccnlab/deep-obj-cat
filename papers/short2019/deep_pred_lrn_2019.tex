...
% (JAR) Two points: 1) begs the question of whether DCCN models 'are' trying to understand human learning and 2) begs the question of whether incorporating biological properties will improve accuracy/speed. Not sure if we want to address either of these in this paper.
\begin{figure}
...
% (JAR) next sentence edited
  ...
  % (JAR) Only mention of `tick` and without explanation
...
% (JAR) It is redundant to say alpha frequency and 10 Hz. There are several places this is done in the paper and it is bothering me :)
