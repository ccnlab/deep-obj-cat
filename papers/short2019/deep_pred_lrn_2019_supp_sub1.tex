...
{\em (14)}, but here we provide a brief overview of architecture. 
...
The model was trained using a batch size of 8 and an Adam optimizer with a learning rate of 0.0001, with no scheduler, for 150,000 iterations.  Training curve shown in Figure~\ref{fig.prednet_lrn}, showing that it achieves the best overall prediction accuracy, and yet has the least well differentiated, categorical representations.
