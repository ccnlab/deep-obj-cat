...
\begin{figure}
  \centering\includegraphics[width=6in]{fig_s01} % figs/fig_deepleabra_wwi_clust_leabra_expt
...
\begin{figure}
  \centering\includegraphics[width=4in]{fig_s02} % figs/fig_deepleabra_wwi_expt1_trial_ex
...
\begin{figure}
  \centering\includegraphics[width=5in]{fig_s03} % figs/fig_deepleabra_wwi_cons_all
...
The general principles and patterns of connectivity are shown in Figure~\ref{fig.model_cons} (and Figure 1 in the main text).  As noted in the main text, the connectivity and overall structure obeys the established principles identified in neocortical anatomy \cite{RocklandPandya79,FellemanVanEssen91,MarkovVezoliChameauEtAl14,MarkovErcsey-RavaszGomesEtAl14}.
...
\begin{figure}
  \centering\includegraphics[width=5.5in]{fig_s04} % figs/fig_deepleabra_wwi_emer_lrn_v1p_simat
...
\begin{figure}
  \centering\includegraphics[width=3in]{fig_s05} % figs/fig_srn_ti_compute
...
\begin{figure}
  \centering\includegraphics[width=2.5in]{fig_s06} % figs/fig_deepleabra_wwi_emer_lrn_bp
...
\begin{figure}
  \centering\includegraphics[width=2.5in]{fig_s07} % figs/fig_deepleabra_wwi_emer_lrn_prednet
...
\begin{figure}
  \centering\includegraphics[width=3.5in]{fig_s08} % figs/fig_deepleabra_wwi_emer_prednet_dropout_meta_within_between
