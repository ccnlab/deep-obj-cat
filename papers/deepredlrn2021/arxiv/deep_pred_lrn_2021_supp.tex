...
\begin{figure}
  \centering\includegraphics[width=4in]{fig_deepleabra_wwi_expt1_trial_ex}
...
Figure~\ref{fig.model} in the main text shows the general configuration of the model, and Table~\ref{tab.layer_sizes} shows the specific sizes of each of the layers, and where they receive inputs from. 
...
\begin{figure}
  \centering\includegraphics[width=5in]{fig_deepleabra_wwi_cons_all}
...
Each neuron learns using a more biologically-based version of the Contrastive Hebbian Learning (CHL) algorithm, as shown in Figure~\ref{fig.dltime}:
\begin{equation}
 \Delta_{chl} = x^+ y^+ - x^- y^-
 \label{eq:chl}
\end{equation}
...
\begin{figure}
  \centering\includegraphics[width=2.5in]{fig_deepleabra_wwi_emer_lrn_bp}
...
\begin{figure}
  \centering\includegraphics[width=2.5in]{fig_deepleabra_wwi_emer_lrn_prednet}
...
\begin{figure}
  \centering\includegraphics[width=3.5in]{fig_deepleabra_wwi_emer_prednet_dropout_meta_within_between}
