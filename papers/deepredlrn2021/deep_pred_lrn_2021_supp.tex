...
\begin{figure}
  \centering\includegraphics[width=2.5in]{figs/fig_deepleabra_wwi_emer_lrn_prednet}
...
\begin{figure}
  \centering\includegraphics[width=3.5in]{figs/fig_deepleabra_wwi_emer_prednet_dropout_meta_within_between}
